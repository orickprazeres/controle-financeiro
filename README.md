...
│   └── anterior/                  modelos e a planilha original, guardados
│
...
│   └── 07-contas-a-pagar.md       vencimentos, pagamentos e contas fixas
│
...
3. Subir a pasta `docs/` para o GitHub e ligar o Pages
...
| Sem vencimento, sem saber o que estava atrasado | `vencimento`, `data_pagamento` e `valor_pago` |
| Nenhum controle de investimento | Carteira, rendimento deduzido e simulador |
...
- O `.gitignore` bloqueia a pasta `importar/` e a planilha original — as duas contêm seus lançamentos reais, e o repositório é público.
